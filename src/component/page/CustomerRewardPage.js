import RetrieveMyRewards from "../../user/employee/reward/RetrieveMyReward";
import ApplyRewards from "../../user/employee/reward/ApplyReward";
import { useState, useEffect } from "react";
import { retrieveContractByCustomerId } from "../../user/employee/reward/Reward";
...
const CustomerRewardPage = () => {
  ...
  useEffect(() => {
    retrieveContractByCustomerId(userID).then((res) => {
