...
const ApplyReward = (res) => {
    ...
    const onSubmitHandle = () => {
        ...
        if (data.contractID && data.content && data.accidentProfile && data.customerid && data.identifyProfile ) {
            save( data ).then( (res) =>
    ...
    return (
        ...
        <>
            ...
            <div> 사고 증빙 자료 </div>
            <input type="text" name="accidentProfile" placeholder="사고 증빙 자료" onChange={ (e) => onHandleChangeData(e) } />
            <div> 본인 증명 서류 </div>
            <input type="text" name="identifyProfile" placeholder="본인 인증 서류" onChange={ (e) => onHandleChangeData(e) } />
